    ...
    <article className="hud-frame flex flex-col gap-3 p-4">
      <header className="flex items-start justify-between gap-3">
        <div>
          ...
          {project.brand && (
            <span className="mt-1 inline-block font-mono text-[10px] uppercase tracking-wider text-ink-faint">
        ...
        <button
          ...
          className="shrink-0 border border-line px-2.5 py-1 font-mono text-[10px] uppercase tracking-wider text-ink-muted transition-colors hover:border-red hover:text-red"
        >
          Abrir no Orca
        </button>
      </header>
      ...
      <dl className="flex flex-col gap-2">
        ...
        <Row label="site">
          {project.hosting ? (
            ...
            <span className="font-mono text-xs text-ink-faint">não configurado</span>
          )}
        </Row>
...
function Row({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex items-center justify-between gap-2">
      <dt className="w-16 shrink-0 font-mono text-[10px] uppercase tracking-wider text-ink-faint">
        {label}
      </dt>
